...
(function() {
  var Toolbar, cookPaintPizza, newBrushPizza;
  ...
  cookPaintPizza = function(stage, layer, toolbar) {
    var R, angle, cx, cy, days, i, text, wedge, _i, _j, _paint, _ref;

    days = ['周日', '周一', '周二', '周三', '周四', '周五', '周六'];
    _ref = [stage.getWidth() / 2, stage.getHeight() / 2, 235], cx = _ref[0], cy = _ref[1], R = _ref[2];
  ...
  Toolbar = (function() {
    ...
    Toolbar.prototype.trigger = function(name) {
      var callback;
